...
public class ClassStrLoadClassTest {

    private static Map<String, JavaFileObject> fileObjects = new ConcurrentHashMap<>();

    @Test
    public void loadAndRun() {
        String code = "package mypackage;public class Myclass {public void hello(){System.out.println(\"hello world\");}";
        ...
        try {
            ...
            String v = Base64.getEncoder().encodeToString(((MyJavaFileObject) fileObjects.get(cls)).getCompiledBytes());
